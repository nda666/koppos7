...
<!-- Modal -->
<div class="modal fade" id="modal-edit" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
   <form action="<?php echo base_url('barang/edit') ?>" method="POST" id="form-edit" role="form" class="form form-horizontal">
       <div class="modal-content">
         ...
         <div class="modal-body">
           ...
           <input type="hidden" name="id_brng">
           <!-- Input Nama -->
           ...
           <div class="form-group">
             ...
             <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
               <input type="text" name="tgl_ex" id="inputTglExp" class="form-control" title="Input Tanggal Masuk">
             </div>
